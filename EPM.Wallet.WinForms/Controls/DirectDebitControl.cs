...
{
    public partial class DirectDebitControl : UserControl, IDirectDebitView
    {
        private readonly IPresenter _presenter;
        private bool _isEventHandlerSets;

        public DirectDebitControl(IDirectDebitDataManager directDebitDataManager, IDataMаnager dataMаnager)
        {
            InitializeComponent();
            _presenter = new DirectDebitPresenter(this, directDebitDataManager, dataMаnager);
        }

        #region IDirectDebitView
